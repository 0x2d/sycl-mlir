...
; No-op case: no `_ZTS15Polybench_3mm_1` / `_ZTS15Polybench_3mm_2` /
; `_ZTS15Polybench_3mm_3` string constant anywhere in the module -> this TU
; launches none of the 3mm kernels and the pass must not touch anything,
; even though one function looks like a 3mm launch site by name and shape.
