...
; No-op case: no `_ZTS4Gemm` string constant anywhere in the module -> this
; TU launches no gemm kernel and the pass must not touch anything, even
; though one function looks like a gemm launch site by name and shape.
